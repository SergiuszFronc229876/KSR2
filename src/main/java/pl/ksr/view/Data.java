...
public class Data {
    ...
    public static void initData() {
        ...
        List<Label> labelsCena = new ArrayList<>(List.of(najtansze, popularne, luksusowe, superLuksusowe, sportowe, superSportowe));
        LinguisticVariable cena = new LinguisticVariable("Cena", labelsCena);

        //Przebieg
        Label do_25_000 = new Label("do 25 000 km", "Przebieg", new FuzzySet(new TrapezoidalFunction(0, 0, 10_000, 25_000), new ContinuousSet(1, 500_000)));
        ...
        List<Label> labelsPrzebieg = new ArrayList<>(List.of(do_25_000, miedzy_10000_75000, miedzy_50000_125000, miedzy_100000_200000, miedzy_175000_300000, miedzy_275000_375000, ponad_375000));
        LinguisticVariable przebieg = new LinguisticVariable("Przebieg", labelsPrzebieg);

        //Moc silnika
        Label slaba = new Label("słaba - poniżej 110", "Moc silnika", new FuzzySet(new TrapezoidalFunction(20, 20, 90, 110), new ContinuousSet(20, 1000)));
        ...
        List<Label> labelsZuzycie = new ArrayList<>(List.of(bardzoEkonomiczne, ekonomiczne, umiarkowanieEkonomiczne, nieekonomiczne));
        ...
        List<Label> labelsPojemnosc = new ArrayList<>(List.of(do1500, miedzy1300_2100, miedzy1800_2700, miedzy2400_3500, miedzy3200_4700, miedzy4400_6200, powyzej5900));
        ...
        List<Label> labelsDlugosc = new ArrayList<>(List.of(mikrosamochod, miejski, kompaktowy, klasySredniej, klasySredniejWyzszej, wyzszej));
        ...
        List<Label> labelsRozstawOsi = new ArrayList<>(List.of(krotki, sredni, dlugi));
        ...
        List<Label> labelsMomentObrotowy = new ArrayList<>(List.of(niski, normalny, wysoki, chipTuning));
        ...
        RelativeQuantifier prawieZaden = new RelativeQuantifier("Mniej niż ćwierć", new FuzzySet(new TrapezoidalFunction(0.00, 0.00, 0.10, 0.20), new ContinuousSet(0, 1)));
        ...
        RelativeQuantifier mniejNizPolowa = new RelativeQuantifier("Mniej niż połowa", new FuzzySet(new TrapezoidalFunction(0.25, 0.30, 0.35, 0.5), new ContinuousSet(0, 1)));
        ...
        RelativeQuantifier niemalWszystkie = new RelativeQuantifier("Znakomita większość", new FuzzySet(new TrapezoidalFunction(0.65, 0.75, 1.00, 1.00), new ContinuousSet(0, 1)));
        relativeQuantifiers = new ArrayList<>();
        relativeQuantifiers.addAll(new ArrayList<>(List.of(prawieZaden, niewiele, mniejNizPolowa, okoloPolowa, sporaCzesc, niemalWszystkie)));

        //Kwantyfikatory Absolutne
        AbsoluteQuantifier mniejNiz2000 = new AbsoluteQuantifier("Mniej niż 2000", new FuzzySet(new TrapezoidalFunction(0, 0, 1000, 2000), new ContinuousSet(0, 11_000)));
        AbsoluteQuantifier okolo3000 = new AbsoluteQuantifier("Około 3000", new FuzzySet(new TrapezoidalFunction(1000, 2000, 3000, 4000), new ContinuousSet(0, 11_000)));
        AbsoluteQuantifier miedzy3000_7000 = new AbsoluteQuantifier("Między 3000 a 7000", new FuzzySet(new TrapezoidalFunction(3000, 4000, 6000, 7000), new ContinuousSet(0, 11_000)));
        AbsoluteQuantifier blisko7000 = new AbsoluteQuantifier("Blisko 7000", new FuzzySet(new TrapezoidalFunction(6000, 7000, 7500, 8500), new ContinuousSet(0, 11_000)));
        AbsoluteQuantifier ponad8000 = new AbsoluteQuantifier("Ponad 8000", new FuzzySet(new TrapezoidalFunction(7500, 8000, 11000, 11000), new ContinuousSet(0, 11_000)));
        absoluteQuantifiers = new ArrayList<>();
        absoluteQuantifiers.addAll(new ArrayList<>(List.of(mniejNiz2000, okolo3000, miedzy3000_7000, blisko7000, ponad8000)));
    }
}
