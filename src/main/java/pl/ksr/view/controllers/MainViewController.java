...
public class MainViewController implements Initializable {
    ...
    private void fillDatabaseTable() {
        ...
        TableColumn<CarDetails, String> column4 = new TableColumn<>("Fuel type");
        TableColumn<CarDetails, String> column5 = new TableColumn<>("Price");
        TableColumn<CarDetails, String> column6 = new TableColumn<>("Mileage");
        TableColumn<CarDetails, String> column7 = new TableColumn<>("Horsepower");
        TableColumn<CarDetails, String> column8 = new TableColumn<>("Eng. disp.");
        TableColumn<CarDetails, String> column9 = new TableColumn<>("Fuel tank vol.");
        TableColumn<CarDetails, String> column10 = new TableColumn<>("Wheelbase");
        TableColumn<CarDetails, String> column11 = new TableColumn<>("Torque");
        TableColumn<CarDetails, String> column12 = new TableColumn<>("Width");
        TableColumn<CarDetails, String> column13 = new TableColumn<>("Length");
        TableColumn<CarDetails, String> column14 = new TableColumn<>("Fuel economy");
        TableColumn<CarDetails, String> column15 = new TableColumn<>("Year");
        ...
        column6.setCellValueFactory(new PropertyValueFactory<>("mileage"));
        column7.setCellValueFactory(new PropertyValueFactory<>("horsepower"));
        column8.setCellValueFactory(new PropertyValueFactory<>("engineDisplacement"));
        column9.setCellValueFactory(new PropertyValueFactory<>("fuelTankVolume"));
        column10.setCellValueFactory(new PropertyValueFactory<>("wheelbase"));
        column11.setCellValueFactory(new PropertyValueFactory<>("torque"));
        column12.setCellValueFactory(new PropertyValueFactory<>("width"));
        column13.setCellValueFactory(new PropertyValueFactory<>("length"));
        column14.setCellValueFactory(new PropertyValueFactory<>("fuelEconomy"));
        column15.setCellValueFactory(new PropertyValueFactory<>("year"));
        column15.setCellValueFactory(new PropertyValueFactory<>("year"));

        carDetailsTable.getColumns().addAll(List.of(column1, column2, column3, column4, column5, column6, column7, column8, column9, column10, column11, column12, column13, column14, column15));
